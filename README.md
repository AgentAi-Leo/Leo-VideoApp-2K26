...
ADDS vers-U 
  ...
  ### NOTE: SUPER CONFUSED NOW AS WE HAVE ENTIRELY MOVED AWAY FROM AVQueuePlayer AND NOW BACK TO AVPlayer FOR SEAMLESS PLAYBACK WITHOUT GLITCHES - WTF SERIOUSLY???!!!
